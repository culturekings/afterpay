...
use CultureKings\Afterpay\Model\Merchant;
 ...
 * @mixin Merchant\OrderDetails
 */
class OrderDetailsSpec extends ObjectBehavior
{
    function it_is_initializable()
    {
        $this->shouldHaveType(Merchant\OrderDetails::class);
    }

    function its_consumer_is_mutable(Merchant\Consumer $consumer)
    {
    ...
    function its_billing_is_mutable(Merchant\Contact $billing)
    {
    ...
    function its_shipping_is_mutable(Merchant\Contact $shipping)
    {
    ...
    function its_courier_is_mutable(Merchant\ShippingCourier $courier)
    {
    ...
    function its_discounts_is_mutable(Merchant\Discount $discount1, Merchant\Discount $discount2)
    {
    ...
    function its_merchant_options_is_mutable(Merchant\MerchantOptions $merchantOptions)
    {
